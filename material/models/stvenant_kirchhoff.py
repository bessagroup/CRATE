#
# St.Venant-Kirchhoff Hyperelastic Constitutive Model (CRATE Program)
# ==========================================================================================
# Summary:
# St.Venant-Kirchhoff hyperelastic constitutive model.
# ------------------------------------------------------------------------------------------
# Development history:
# Bernardo P. Ferreira | Jan 2022 | Initial coding.
# ==========================================================================================
#                                                                             Import modules
# ==========================================================================================
# Working with arrays
...
class StVenantKirchhoff(ConstitutiveModel):
    ...
    def state_init(self):
        ...
        Constitutive model state variables:
            e_strain_mf  | Elastic deformation gradient tensor (matricial form)
            strain_mf    | Deformation gradient tensor (matricial form)
            stress_mf    | First-Piola Kirchhoff stress tensor (matricial form)
        ...
        state_variables_init['e_strain_mf'] = \
            mop.get_tensor_mf(np.eye(self._n_dim), self._n_dim, self._comp_order_nsym)
    ...
    def state_update(self, inc_strain, state_variables_old, su_max_n_iterations=20,
        ...
        inc_strain_mf = mop.get_tensor_mf(inc_strain, self._n_dim, self._comp_order_nsym)
        #
        #                                                                 2D > 3D conversion
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        if self._problem_type == 4:
            ...
            # Build deformation gradient tensors (matricial form) by including the
        ...
        e_strain_old = mop.get_tensor_from_mf(e_strain_old_mf, n_dim, comp_order_nsym)
        inc_strain = mop.get_tensor_from_mf(inc_strain_mf, n_dim, comp_order_nsym)
        ...
        elastic_tangent_mf = Elastic.elastic_tangent_modulus(self._material_properties,
        ...
        second_piola_stress = mop.get_tensor_from_mf(second_piola_stress_mf, n_dim,
                                                     comp_order_sym)
        # Compute first Piola-Kirchhoff stress tensor
        first_piola_stress = first_piola_from_second_piola(e_strain, second_piola_stress)
        # Build first Piola-Kirchhoff stress tensor matricial form
        stress_mf = mop.get_tensor_mf(first_piola_stress, n_dim, comp_order_nsym)
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        elastic_tangent = mop.get_tensor_from_mf(elastic_tangent_mf, n_dim, comp_order_sym)
        # Compute derivative of Kirchhoff stress tensor in order to the elastic deformation
        # gradient tensor
        der_kirchhoff_e_strain = \
            ...
            top.dot24_1(e_strain, top.dot24_2(e_strain,
                                              top.dot24_3(e_strain, elastic_tangent)))
