...
# ==========================================================================================
# Summary:
# Procedures related to the generation of a finite element code Links' input data file,
# including the discretization of the RVE in a regular quadrilateral (2D) / hexahedral (3D)
# finite element mesh.
# ------------------------------------------------------------------------------------------
# Development history:
...
def writelinksinputdatafile(file_name, dirs_dict, problem_dict, mat_dict, rg_dict,
    ...
    coords, connectivities, element_phases = genlinksfemesh(n_dim, rve_dims, n_voxels_dims,
...
# elements
def genlinksfemesh(n_dim, rve_dims, n_voxels_dims, regular_grid, fe_order):
...
def writelinksfemesh(file_path, n_dim, n_material_phases, material_phases,
                     material_properties, material_phases_models, fe_order, coords,
                     connectivities, element_phases):
