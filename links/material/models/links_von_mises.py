...
# ==========================================================================================
# Summary:
# Von Mises constitutive model from Links (Large Strain Implicit Nonlinear Analysis of
...
# ==========================================================================================
class LinksVonMises(LinksConstitutiveModel):
    '''Von Mises constitutive model.
    ...
    def get_state_variables(self, stres, rstava, lalgva, ralgva):
        ...
        '''
        # Get Links parameters
        links_comp_order_sym, _ = LinksUtil.getlinkscomporder(self._n_dim)
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        raise RuntimeError('Links constitutive model must return the total strain.')
        if self._problem_type == 1:
